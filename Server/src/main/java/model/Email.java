...
public class Email implements Externalizable {
    ...
    public Email() {
        this.id.set(this.generateRandomId());
    ...
    public String generateRandomId() {
        return Math.abs(Long.valueOf(UUID.randomUUID().getMostSignificantBits()).intValue()) + "";
    }

    @Override
    public boolean equals(Object obj) {
        if(obj instanceof Email) {
            Email emailToCompare = (Email) obj;
            return this.getId().equals(emailToCompare.getId());
        }
        return false;
    }
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        out.writeUTF(this.getSubject() != null ? this.getSubject() : "");
        out.writeUTF(this.getBody() != null ? this.getBody() : "");
